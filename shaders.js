...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec2 uv = min(fragCoord.xy / iResolution.xy, 1.0);
    ...
    float T = ratio*10000.0+1900.0;    //K  is the temperature in Kelvin (add 273 degrees to Celcius temperatures to get Kelvin)
